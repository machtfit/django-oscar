...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benefit.can_apply_with_other_benefits'
        db.add_column(u'offer_benefit', 'can_apply_with_other_benefits',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benefit.can_apply_with_other_benefits'
        db.delete_column(u'offer_benefit', 'can_apply_with_other_benefits')
    ...
    models = {
        ...
        u'offer.benefit': {
            ...
            'can_apply_with_other_benefits': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
